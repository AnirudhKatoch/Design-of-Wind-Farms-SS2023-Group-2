...
#============================ Bayern-DE 100m =================================
#=============================================================================
data = pd.read_csv("inputs/final_proyect/mesotimeseries_Bayern_DK_100m.csv")
...
coordinates= ['(3052.26, 1159.60)', '(999.89, 803.75)', '(4550.65, 2092.52)', '(2494.92, 3316.56)', '(4659.41, 5078.63)', '(1255.11, 4189.58)', '(4234.04, 3837.26)', '(722.51, 2375.45)', '(2527.22, 4567.45)', '(2155.43, 2034.84)']
x_coordinates = []
y_coordinates = []
...
landbosse_cost = 34.024757         #[Million $]
...
A = [110.4,268.5,193.7,96.9,71.6,63.1,67.4,59.1,51.7,47.0,42.0,42.0,42.0,42.0,42.0,42.0,42.0,42.0,42.0,42.0,42.0]

spot_prices = []  # List to store spot prices

# Multiply the wind speed data with the funcion to calculate the spot price for each wind speed. Afterwards this value is muliplied with the wind rose frequency to consider the wind resource distribution. 
for value in A:
    spot_price = value*(1.145-0.03755*(110/120)**alpha*data.ws)
