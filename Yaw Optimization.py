...
def load_floris():
    ...
    farm_layout = [(4742.21, 3065.92), (1240.12, 970.56), (5796.07, 2075.36), (5376.62, 377.83), (1941.53, 374.4), (3426.17, 3539.72), (1332.96, 1998.84), (4036.91, 1203.28), (7534.12, 2274.65), (3691.28, 2256.38), (4755.86, 1838.79), (6604.28, 2544.03), (2303.68, 2881.67), (6647.03, 1368.24), (3006.96, 150.31)]
    layout_x = [coord[0] for coord in farm_layout]
    layout_y = [coord[1] for coord in farm_layout]
    fi.reinitialize(layout_x=layout_x, layout_y=layout_y)

    return fi

def load_windrose():
    fn = "nc_files/mesotimeseries_Kastrup-DK120m_with_freq/mesotimeseries_Kastrup-DK120m_with_freq.csv"
    df = pd.read_csv(fn)
...
if __name__ == "__main__":
    ...
    yaw_opt = YawOptimizationSR(
        ...
        minimum_yaw_angle= -7.5,  # Allowable yaw angles lower bound
        maximum_yaw_angle= 4.0,  # Allowable yaw angles upper bound
        Ny_passes=[10, 10],
    ...
    # output_data = pd.DataFrame(yaw_angles_opt)
    # output_data.to_csv("Trial.csv", index=False)
    ...
    for ii, idx in enumerate(df_windrose.index):
        ...
        if (wind_speed < 3.0) | (wind_speed > 25.0):
            ...
            yaw_opt = yaw_opt_full * (25.0 - wind_speed) / 2.0  # Linear ramp down
        else:
